...
--
-- Client: localhost
-- Généré le: Mer 26 Juin 2013 à 11:12
...
(4, 3, 'User_Model_Action_Default::1', 'User_Model_Role', 2),
(6, 3, 'User_Model_Action_Default::1', 'User_Model_User', 3),
(3, 3, 'User_Model_Action_Default::16', 'User_Model_Role', 1),
(5, 3, 'User_Model_Action_Default::2', 'User_Model_Role', 2),
(1, 3, 'User_Model_Action_Default::4', 'User_Model_Role', 1),
(7, 3, 'User_Model_Action_Default::4', 'User_Model_User', 3),
(2, 3, 'User_Model_Action_Default::8', 'User_Model_Role', 1);
...
CREATE TABLE `af_action_setalgovalue` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_action_setoptionstate` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_action_setstate` (
  `id` int(11) NOT NULL,
  `state` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `af_action_setvalue` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `af_action_setvalue_checkbox` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_action_setvalue_numeric` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_action_setvalue_select_multi` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_action_setvalue_select_single` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_component_checkbox` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_component_field` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_component_group` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_component_numeric` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_component_select` (
  `id` int(11) NOT NULL,
  `required` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `af_component_select_multi` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_component_select_multi_defaultvalues` (
...
CREATE TABLE `af_component_select_option` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `label` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `visible` tinyint(1) NOT NULL,
...
CREATE TABLE `af_component_select_single` (
  `id` int(11) NOT NULL,
  `type` int(11) NOT NULL,
...
CREATE TABLE `af_component_subaf` (
  `id` int(11) NOT NULL,
  `foldaway` int(11) NOT NULL,
...
CREATE TABLE `af_component_subaf_notrepeated` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `af_component_subaf_repeated` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_condition_elementary` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_condition_elementary_checkbox` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_condition_elementary_numeric` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_condition_elementary_select_multi` (
  `id` int(11) NOT NULL,
  `idOption` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `af_condition_elementary_select_single` (
  `id` int(11) NOT NULL,
  `idOption` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `af_condition_expression` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_inputset_primary` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_input_checkbox` (
  `id` int(11) NOT NULL,
  `value` tinyint(1) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `af_input_select_multi` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_input_select_single` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_input_subaf_notrepeated` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `af_input_subaf_repeated` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `af_input_subaf_repeated_value` (
...
CREATE TABLE `af_output_element` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `value` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `label` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `af_output_element_indexes` (
...
CREATE TABLE `af_output_outputset` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `idInputSet` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `algo_condition_elementary` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `algo_condition_elementary_boolean` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `algo_condition_elementary_numeric` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `algo_condition_elementary_select` (
  `id` int(11) NOT NULL,
  `value` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `algo_condition_elementary_select_multi` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `algo_condition_elementary_select_single` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `algo_condition_expression` (
  `id` int(11) NOT NULL,
  `expression` longtext COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `algo_numeric_constant` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `algo_numeric_expression` (
  `id` int(11) NOT NULL,
  `unit` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `expression` longtext COLLATE utf8_unicode_ci NOT NULL,
  `idExpression` int(11) NOT NULL,
...
CREATE TABLE `algo_numeric_input` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `algo_numeric_parameter` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `algo_parametercoordinate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `algo_parametercoordinate_algo` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `algo_parametercoordinate_fixed` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `algo_selection_main` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `algo_selection_textkey` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `algo_selection_textkey_expression` (
  `id` int(11) NOT NULL,
  `expression` longtext COLLATE utf8_unicode_ci NOT NULL,
  `idExpression` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `algo_selection_textkey_input` (
  `id` int(11) NOT NULL,
  `inputRef` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `classif_contextindicator` (
...
CREATE TABLE `classif_contextindicator_axes` (
  `idContext` int(11) NOT NULL,
  `idIndicator` int(11) NOT NULL,
...
CREATE TABLE `classif_indicator` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `label` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `position` int(11) NOT NULL,
...
CREATE TABLE `classif_member_association` (
...
CREATE TABLE `doc_bibliography_referenceddocuments` (
...
CREATE TABLE `dw_member_association` (
  `idParent` int(11) NOT NULL,
  `idChild` int(11) NOT NULL,
  PRIMARY KEY (`idParent`,`idChild`),
...
CREATE TABLE `inventory_association` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `inventory_ordered` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `position` int(11) NOT NULL,
...
CREATE TABLE `inventory_simpleassociation` (
...
CREATE TABLE `inventory_simpleexample` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci AUTO_INCREMENT=1 ;
...
CREATE TABLE `inventory_translated` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `keyword_predicate` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `label` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `orga_cell_afinputsetprimarycomments` (
...
CREATE TABLE `orga_cell_contextactions` (
  `idCell` int(11) NOT NULL,
...
CREATE TABLE `orga_cell_dwresults` (
  `idCell` int(11) NOT NULL,
...
CREATE TABLE `orga_cell_genericactions` (
  `idCell` int(11) NOT NULL,
...
CREATE TABLE `orga_granularity_axis` (
...
CREATE TABLE `orga_granularity_dwreport` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `orga_granularity_dwreport_cell_dwreport` (
...
CREATE TABLE `orga_member_association` (
  `idParent` int(11) NOT NULL,
  `idChild` int(11) NOT NULL,
  PRIMARY KEY (`idParent`,`idChild`),
...
CREATE TABLE `simulation_scenario_dwresults` (
...
CREATE TABLE `social_actionkeyfigure` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `label` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `social_action_comments` (
...
CREATE TABLE `social_contextaction` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `social_contextactionkeyfigure` (
  `value` double DEFAULT NULL,
...
CREATE TABLE `social_genericaction` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `social_message_group_recipients` (
...
CREATE TABLE `social_message_user_recipients` (
  `idMessage` int(11) NOT NULL,
  `idUser` int(11) NOT NULL,
...
CREATE TABLE `social_news_comments` (
...
CREATE TABLE `social_usergroup_users` (
...
CREATE TABLE `techno_component_tags` (
...
CREATE TABLE `techno_element_coeff` (
  `id` int(11) NOT NULL,
  `value` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `techno_element_process` (
  `id` int(11) NOT NULL,
  `value` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `techno_family_cell` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `techno_family_cells_common_tags` (
  `idFamily` int(11) NOT NULL,
  `idTag` int(11) NOT NULL,
...
CREATE TABLE `techno_family_cell_members` (
  `idCell` int(11) NOT NULL,
  `idMember` int(11) NOT NULL,
  PRIMARY KEY (`idCell`,`idMember`),
...
CREATE TABLE `techno_family_coeff` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `techno_family_dimension` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `position` int(11) NOT NULL,
...
CREATE TABLE `techno_family_member` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
...
CREATE TABLE `techno_family_process` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `unit_discreteunit` (
  `id` int(11) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
...
CREATE TABLE `unit_extendedunit` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `unit_physicalquantity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
...
CREATE TABLE `unit_physicalquantitycomponent` (
...
CREATE TABLE `unit_standardunit` (
  `id` int(11) NOT NULL,
...
CREATE TABLE `unit_unitextension` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ref` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_unicode_ci DEFAULT NULL,
  `symbol` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
...
CREATE TABLE `user_securityidentity` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `type` varchar(255) COLLATE utf8_unicode_ci NOT NULL,
  PRIMARY KEY (`id`)
...
(3, 'Administrateur', NULL, 'admin', 0, NULL, 1, 'b2302c515a17bdb2bbe22b8fedaff704', '2013-06-26 08:59:35', NULL);
