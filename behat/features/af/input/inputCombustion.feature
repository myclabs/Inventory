...
Feature: Combustion input feature
  ...
  # Vérification contenu pour un algo de type "Expression numérique"
    ...
    When I click element "#collapse_combustion_combustible_unite_masse__emissions_amont .fa-search"
  ...
  # Vérification contenu pour un algo de type "paramètre"
    ...
    When I click element "#collapse_combustion_combustible_unite_masse__emissions_amont__fe_amont a:contains('Combustion de combustible, mesuré en unité de masse')"
