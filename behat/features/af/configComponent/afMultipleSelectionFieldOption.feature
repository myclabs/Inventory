...
Feature: AF multiple selection field option feature
  ...
  @javascript
  Scenario: Creation of a multiple selection field option scenario, correct input
  ...
  @javascript
  Scenario: Edition of a multiple selection field option scenario, correct input
# Accès au popup des options
    Given I am on "af/edit/menu/id/4"
    And I wait for the page to finish loading
    And I open tab "Composants"
