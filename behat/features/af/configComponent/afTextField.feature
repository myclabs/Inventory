...
Feature: AF text field feature
  ...
  @javascript
  Scenario: Creation of a text field, correct input
  ...
  @javascript
  Scenario: Creation of a text field, incorrect input
    Given I am on "af/edit/menu/id/4"
    And I wait for the page to finish loading
    And I open tab "Composants"
    And I open collapse "Champs texte"
  ...
  @javascript
  Scenario: Edition of an AF text field, correct input
    Given I am on "af/edit/menu/id/4"
    And I wait for the page to finish loading
    And I open tab "Composants"
    And I open collapse "Champs texte"
  ...
  @javascript
  Scenario: Edition of an AF text field, incorrect input
    Given I am on "af/edit/menu/id/4"
    And I wait for the page to finish loading
    And I open tab "Composants"
    And I open collapse "Champs texte"
