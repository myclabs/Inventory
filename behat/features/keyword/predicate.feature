...
Feature: Keyword
  ...
  # On commence par l'ajouter
    ...
    Then the "#messageZone" element should not contain "Ajout effectué."
  # Puis on le supprime
    When I click "Supprimer"
    Then I should see the popup "Demande de confirmation"
    When I click "Confirmer"
    Then the "#messageZone" element should contain "Suppression effectuée."
    When I click element "#messageZone button.close"
    And I wait 1 seconds
    Then the "#messageZone" element should not contain "Suppression effectuée."
  # Ajout correct
    When I click "Ajouter"
    Then I should see the popup "Ajout d'une paire prédicat / prédicat inverse"
