...
Feature: Family edit feature
  ...
  @javascript
  Scenario: Family process edit general data scenario, correct input
  ...
  # Vérification du contenu des différents champs du formulaire "Général"
    Then the "Type" field should contain "process"
  ...
  @javascript
  Scenario: Family process edit general data scenario, incorrect input
    Given I am on "techno/family/edit/id/3"
    And I wait for the page to finish loading
    When I open tab "Général"
  ...
  @javascript
  Scenario: Family edit elements scenario
    Given I am on "techno/family/edit/id/3"
    And I wait for the page to finish loading
