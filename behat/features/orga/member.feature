...
Feature: orgaMember
  ...
  @javascript
  Scenario: Creation and free deletion of a member
  ...
  @javascript
  Scenario: Edition of a member's attributes (label and identifier)
  # Accès à l'onglet "Membres"
    Given I am on "orga/cell/details/idCell/1"
    And I wait for the page to finish loading
    And I open tab "Organisation"
  ...
  @javascript
  Scenario: Creation of a member in an axis having a broader axis, and edition of parent member
  # Accès à l'onglet "Membres"
    Given I am on "orga/cell/details/idCell/1"
    And I wait for the page to finish loading
    And I open tab "Organisation"
