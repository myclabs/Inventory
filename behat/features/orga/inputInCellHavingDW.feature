...
Feature: Input in a cell associated to a DW feature
  ...
  # Modification du formulaire associé à une zone-marque
    ...
    And I set "Combustion de combustible, mesuré en unité de masse" for column "af" of row 1 of the "datagridCellAfs2" datagrid with a confirmation message
  # Accès à la cellule "Europe | Marque A"
  # Accès à la saisie
    And I am on "orga/cell/input/idCell/2/fromIdCell/1/"
    And I wait for the page to finish loading
  # Saisie
  ...
  # Réalisation et lancement d'une analyse pour vérifier que la saisie a bien été prise en compte
    And I click element "legend[data-target='#granularity2']"
    And I click element "a[href='#reports2']"
