...
Feature: Organization input change configuration feature
  ...
  @javascript
  Scenario: Deny the ability to change unit of a numeric field while an input already exists and unit has been changed for this input
    Given I am on "orga/cell/input/cell/39/fromCell/1"
    And I wait for the page to finish loading
    Then I should see "Saisie 2012 | Annecy | Énergie"
    When I fill in "quantite_combustible" with "1000"
    And I click element "[name='quantite_combustible_unit'] [value='kg']"
