...
Feature: My account feature
  ...
  @javascript
  Scenario: Change my first and last names
    Given I am on the homepage
    And I wait for the page to finish loading
  # Login en tant que "emmanuel.risler.pro@gmail.com"
  ...
  # TODO : on devrait afficher "Aucune modification effectuée"
  ...
  # Accès au formulaire de modification de l'adresse e-mail
    When I click element "#email .btn:contains('Éditer')"
  ...
  # Accès au formulaire de modification du mot de passe
    When I click element "#password .btn:contains('Éditer')"
