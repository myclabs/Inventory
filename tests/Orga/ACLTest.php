...
class Orga_Test_ACL extends Core_Test_TestCase
{
    ...
    public function setUp()
    {
        ...
        /** @var Orga_Service_ACLManager $aclManagerService */
        $aclManagerService = $container->get('Orga_Service_ACLManager');
        $this->userService = $container->get('User_Service_User');
        $this->aclService = $container->get('User_Service_ACL');
    ...
    public function tIsAllowOrganizationAdministrator()
    {
        ...
        // Organisation.
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $this->organization));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $this->organization));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $this->organization));

        // Cellules de la granularité global.
        $cell0 = $this->granularityGlobale->getCellByMembers([]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell0));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell0));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell0));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellEuropeA));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellEuropeA));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellEuropeA));
        $cellEuropeB = $this->granularityZoneMarque->getCellByMembers([$this->memberZoneEurope, $this->memberMarqueB]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellEuropeB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellEuropeB));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellEuropeB));
        $cellSudameriqueA = $this->granularityZoneMarque->getCellByMembers([$this->memberZoneSudamerique, $this->memberMarqueA]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellSudameriqueA));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellSudameriqueA));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellSudameriqueA));
        $cellSudameriqueB = $this->granularityZoneMarque->getCellByMembers([$this->memberZoneSudamerique, $this->memberMarqueB]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellSudameriqueB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellSudameriqueB));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellSudameriqueB));

        // Cellules de la granularité site.
        $cellAnnecy = $this->granularitySite->getCellByMembers([$this->memberSiteAnnecy]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellAnnecy));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellAnnecy));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellAnnecy));
        $cellChambery = $this->granularitySite->getCellByMembers([$this->memberSiteChambery]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellChambery));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellChambery));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellChambery));
        $cellBerlin = $this->granularitySite->getCellByMembers([$this->memberSiteBerlin]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellBerlin));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellBerlin));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellBerlin));
        $cellLima = $this->granularitySite->getCellByMembers([$this->memberSiteLima]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellLima));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellLima));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellLima));

        // Cellules de la granularité année.
        $cell2012 = $this->granularityAnnee->getCellByMembers([$this->memberAnnee2012]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012));
        $cell2013 = $this->granularityAnnee->getCellByMembers([$this->memberAnnee2013]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Energie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Energie));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Energie));
        $cell2012Transport = $this->granularityAnneeCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberCategorieTransport]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Transport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Transport));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Transport));
        $cell2013Energie = $this->granularityAnneeCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberCategorieEnergie]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Energie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Energie));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Energie));
        $cell2013Transport = $this->granularityAnneeCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberCategorieTransport]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Transport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Transport));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Transport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012EuropeA));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012EuropeA));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012EuropeA));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012EuropeB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012EuropeB));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012EuropeB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012SudameriqueA));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012SudameriqueA));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012SudameriqueA));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012SudameriqueB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012SudameriqueB));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012SudameriqueB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013EuropeA));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013EuropeA));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013EuropeA));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013EuropeB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013EuropeB));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013EuropeB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013SudameriqueA));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013SudameriqueA));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013SudameriqueA));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013SudameriqueB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013SudameriqueB));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013SudameriqueB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Annecy));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Annecy));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Annecy));
        $cell2012Chambery = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2012, $this->memberSiteChambery]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Chambery));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Chambery));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Chambery));
        $cell2012Berlin = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2012, $this->memberSiteBerlin]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Berlin));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Berlin));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Berlin));
        $cell2012Lima = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2012, $this->memberSiteLima]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Lima));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Lima));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Lima));
        $cell2013Annecy = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2013, $this->memberSiteAnnecy]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Annecy));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Annecy));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Annecy));
        $cell2013Chambery = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2013, $this->memberSiteChambery]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Chambery));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Chambery));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Chambery));
        $cell2013Berlin = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2013, $this->memberSiteBerlin]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Berlin));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Berlin));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Berlin));
        $cell2013Lima = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2013, $this->memberSiteLima]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Lima));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Lima));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Lima));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012AnnecyEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012AnnecyEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012AnnecyEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012ChamberyEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012ChamberyEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012ChamberyEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012BerlinEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012BerlinEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012BerlinEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012LimaEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012LimaEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012LimaEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013AnnecyEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013AnnecyEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013AnnecyEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013ChamberyEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013ChamberyEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013ChamberyEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013BerlinEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013BerlinEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013BerlinEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013LimaEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013LimaEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013LimaEnergie));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012AnnecyTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012AnnecyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012AnnecyTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012ChamberyTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012ChamberyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012ChamberyTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012BerlinTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012BerlinTransport));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012BerlinTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012LimaTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012LimaTransport));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012LimaTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013AnnecyTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013AnnecyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013AnnecyTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013ChamberyTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013ChamberyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013ChamberyTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013BerlinTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013BerlinTransport));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013BerlinTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013LimaTransport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013LimaTransport));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013LimaTransport));

        // Report granularité globale.
        $reportGlobale = $this->granularityGlobale->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportGlobale));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportGlobale));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportGlobale));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportGlobale));

        $reportCellGlobale = $cell0->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportCellGlobale));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportCellGlobale));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportCellGlobale));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportCellGlobale));

        // Report granularité zone marque.
        $reportZoneMarque = $this->granularityZoneMarque->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportZoneMarque));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportZoneMarque));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportZoneMarque));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportZoneMarque));

        $reportEuropeA = $cellEuropeA->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportEuropeA));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportEuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportEuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportEuropeA));
        $reportEuropeB = $cellEuropeB->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportEuropeB));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportEuropeB));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportEuropeB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportEuropeB));
        $reportSudameriqueA = $cellSudameriqueA->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportSudameriqueA));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportSudameriqueA));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportSudameriqueA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportSudameriqueA));
        $reportSudameriqueB = $cellSudameriqueB->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportSudameriqueB));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportSudameriqueB));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportSudameriqueB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportSudameriqueB));

        // Report granularité site.
        $reportSite = $this->granularitySite->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportSite));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportSite));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportSite));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportSite));

        $reportAnnecy = $cellAnnecy->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportAnnecy));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportAnnecy));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportAnnecy));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportAnnecy));
        $reportChambery = $cellChambery->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportChambery));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportChambery));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportChambery));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportChambery));
        $reportBerlin = $cellBerlin->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportBerlin));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportBerlin));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportBerlin));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportBerlin));
        $reportLima = $cellLima->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportLima));
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportLima));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportLima));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportLima));
    }
    ...
    public function tIsAllowGlobaleCellAdministrator()
    {
        ...
        // Organisation.
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $this->organization));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $this->organization));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $this->organization));
        ...
        // Report granularité globale.
        $reportGlobale = $this->granularityGlobale->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportGlobale));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportGlobale));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportGlobale));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportGlobale));
        ...
        // Report granularité zone marque.
        $reportZoneMarque = $this->granularityZoneMarque->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportZoneMarque));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportZoneMarque));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportZoneMarque));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportZoneMarque));
        ...
        // Report granularité site.
        $reportSite = $this->granularitySite->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportSite));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportSite));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportSite));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportSite));
    ...
    public function tIsAllowEuropeACellContributor()
    {
        ...
        // Cellules de la granularité global.
        $cell0 = $this->granularityGlobale->getCellByMembers([]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell0));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell0));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell0));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cellEuropeA));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cellEuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellEuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellEuropeA));
        $cellEuropeB = $this->granularityZoneMarque->getCellByMembers([$this->memberZoneEurope, $this->memberMarqueB]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellEuropeB));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellEuropeB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellEuropeB));
        $cellSudameriqueA = $this->granularityZoneMarque->getCellByMembers([$this->memberZoneSudamerique, $this->memberMarqueA]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellSudameriqueA));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellSudameriqueA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellSudameriqueA));
        $cellSudameriqueB = $this->granularityZoneMarque->getCellByMembers([$this->memberZoneSudamerique, $this->memberMarqueB]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellSudameriqueB));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellSudameriqueB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellSudameriqueB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cellAnnecy));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cellAnnecy));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellAnnecy));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellAnnecy));
        $cellChambery = $this->granularitySite->getCellByMembers([$this->memberSiteChambery]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellChambery));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cellChambery));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cellChambery));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellChambery));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellChambery));
        $cellBerlin = $this->granularitySite->getCellByMembers([$this->memberSiteBerlin]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellBerlin));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellBerlin));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellBerlin));
        $cellLima = $this->granularitySite->getCellByMembers([$this->memberSiteLima]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellLima));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cellLima));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellLima));

        // Cellules de la granularité année.
        $cell2012 = $this->granularityAnnee->getCellByMembers([$this->memberAnnee2012]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012));
        $cell2013 = $this->granularityAnnee->getCellByMembers([$this->memberAnnee2013]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013));

        // Cellules de la granularité année categorie.
        $cell2012Energie = $this->granularityAnneeCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberCategorieEnergie]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Energie));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Energie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Energie));
        $cell2012Transport = $this->granularityAnneeCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberCategorieTransport]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Transport));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Transport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Transport));
        $cell2013Energie = $this->granularityAnneeCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberCategorieEnergie]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Energie));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Energie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Energie));
        $cell2013Transport = $this->granularityAnneeCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberCategorieTransport]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Transport));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Transport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Transport));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2012EuropeA));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2012EuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012EuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012EuropeA));
        $cell2012EuropeB = $this->granularityAnneeZoneMarque->getCellByMembers([$this->memberAnnee2012, $this->memberZoneEurope, $this->memberMarqueB]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012EuropeB));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012EuropeB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012EuropeB));
        $cell2012SudameriqueA = $this->granularityAnneeZoneMarque->getCellByMembers([$this->memberAnnee2012, $this->memberZoneSudamerique, $this->memberMarqueA]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012SudameriqueA));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012SudameriqueA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012SudameriqueA));
        $cell2012SudameriqueB = $this->granularityAnneeZoneMarque->getCellByMembers([$this->memberAnnee2012, $this->memberZoneSudamerique, $this->memberMarqueB]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012SudameriqueB));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012SudameriqueB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012SudameriqueB));
        $cell2013EuropeA = $this->granularityAnneeZoneMarque->getCellByMembers([$this->memberAnnee2013, $this->memberZoneEurope, $this->memberMarqueA]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013EuropeA));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2013EuropeA));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2013EuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013EuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013EuropeA));
        $cell2013EuropeB = $this->granularityAnneeZoneMarque->getCellByMembers([$this->memberAnnee2013, $this->memberZoneEurope, $this->memberMarqueB]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013EuropeB));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013EuropeB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013EuropeB));
        $cell2013SudameriqueA = $this->granularityAnneeZoneMarque->getCellByMembers([$this->memberAnnee2013, $this->memberZoneSudamerique, $this->memberMarqueA]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013SudameriqueA));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013SudameriqueA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013SudameriqueA));
        $cell2013SudameriqueB = $this->granularityAnneeZoneMarque->getCellByMembers([$this->memberAnnee2013, $this->memberZoneSudamerique, $this->memberMarqueB]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013SudameriqueB));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013SudameriqueB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013SudameriqueB));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2012Annecy));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2012Annecy));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Annecy));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Annecy));
        $cell2012Chambery = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2012, $this->memberSiteChambery]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Chambery));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2012Chambery));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2012Chambery));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Chambery));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Chambery));
        $cell2012Berlin = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2012, $this->memberSiteBerlin]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Berlin));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Berlin));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Berlin));
        $cell2012Lima = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2012, $this->memberSiteLima]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Lima));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012Lima));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Lima));
        $cell2013Annecy = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2013, $this->memberSiteAnnecy]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Annecy));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2013Annecy));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2013Annecy));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Annecy));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Annecy));
        $cell2013Chambery = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2013, $this->memberSiteChambery]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Chambery));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2013Chambery));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2013Chambery));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Chambery));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Chambery));
        $cell2013Berlin = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2013, $this->memberSiteBerlin]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Berlin));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Berlin));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Berlin));
        $cell2013Lima = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2013, $this->memberSiteLima]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Lima));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013Lima));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Lima));
        ...
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2012AnnecyEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2012AnnecyEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012AnnecyEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012AnnecyEnergie));
        $cell2012ChamberyEnergie = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberSiteChambery, $this->memberCategorieEnergie]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012ChamberyEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2012ChamberyEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2012ChamberyEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012ChamberyEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012ChamberyEnergie));
        $cell2012BerlinEnergie = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberSiteBerlin, $this->memberCategorieEnergie]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012BerlinEnergie));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012BerlinEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012BerlinEnergie));
        $cell2012LimaEnergie = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberSiteLima, $this->memberCategorieEnergie]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012LimaEnergie));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012LimaEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012LimaEnergie));
        $cell2013AnnecyEnergie = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteAnnecy, $this->memberCategorieEnergie]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013AnnecyEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2013AnnecyEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2013AnnecyEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013AnnecyEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013AnnecyEnergie));
        $cell2013ChamberyEnergie = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteChambery, $this->memberCategorieEnergie]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013ChamberyEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2013ChamberyEnergie));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2013ChamberyEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013ChamberyEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013ChamberyEnergie));
        $cell2013BerlinEnergie = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteBerlin, $this->memberCategorieEnergie]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013BerlinEnergie));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013BerlinEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013BerlinEnergie));
        $cell2013LimaEnergie = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteLima, $this->memberCategorieEnergie]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013LimaEnergie));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013LimaEnergie));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013LimaEnergie));
        $cell2012AnnecyTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberSiteAnnecy, $this->memberCategorieTransport]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012AnnecyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2012AnnecyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2012AnnecyTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012AnnecyTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012AnnecyTransport));
        $cell2012ChamberyTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberSiteChambery, $this->memberCategorieTransport]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012ChamberyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2012ChamberyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2012ChamberyTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012ChamberyTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012ChamberyTransport));
        $cell2012BerlinTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberSiteBerlin, $this->memberCategorieTransport]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012BerlinTransport));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012BerlinTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012BerlinTransport));
        $cell2012LimaTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberSiteLima, $this->memberCategorieTransport]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012LimaTransport));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2012LimaTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012LimaTransport));
        $cell2013AnnecyTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteAnnecy, $this->memberCategorieTransport]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013AnnecyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2013AnnecyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2013AnnecyTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013AnnecyTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013AnnecyTransport));
        $cell2013ChamberyTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteChambery, $this->memberCategorieTransport]);
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013ChamberyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::COMMENT(), $cell2013ChamberyTransport));
        $this->assertTrue($this->aclService->isAllowed($user, Orga_Action_Cell::INPUT(), $cell2013ChamberyTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013ChamberyTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013ChamberyTransport));
        $cell2013BerlinTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteBerlin, $this->memberCategorieTransport]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013BerlinTransport));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013BerlinTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013BerlinTransport));
        $cell2013LimaTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteLima, $this->memberCategorieTransport]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013LimaTransport));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $cell2013LimaTransport));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013LimaTransport));
        ...
        $reportCellGlobale = $cell0->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportCellGlobale));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportCellGlobale));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportCellGlobale));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportCellGlobale));
        ...
        $reportEuropeA = $cellEuropeA->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportEuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportEuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportEuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportEuropeA));
        $reportEuropeB = $cellEuropeB->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportEuropeB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportEuropeB));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportEuropeB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportEuropeB));
        $reportSudameriqueA = $cellSudameriqueA->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportSudameriqueA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportSudameriqueA));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportSudameriqueA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportSudameriqueA));
        $reportSudameriqueB = $cellSudameriqueB->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportSudameriqueB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportSudameriqueB));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportSudameriqueB));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportSudameriqueB));
        ...
        $reportAnnecy = $cellAnnecy->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportAnnecy));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportAnnecy));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportAnnecy));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportAnnecy));
        $reportChambery = $cellChambery->getDWCube()->getReports()[0];
        $this->assertTrue($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportChambery));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportChambery));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportChambery));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportChambery));
        $reportBerlin = $cellBerlin->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportBerlin));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportBerlin));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportBerlin));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportBerlin));
        $reportLima = $cellLima->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportLima));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportLima));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportLima));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportLima));
    }
    ...
    public function tIsAllowSudameriqueBCellObserver()
    {
        ...
        // Cellules de la granularité zonne marque.
        $cellEuropeA = $this->granularityZoneMarque->getCellByMembers([$this->memberZoneEurope, $this->memberMarqueA]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellEuropeA));
        ...
        // Cellules de la granularité site.
        $cellAnnecy = $this->granularitySite->getCellByMembers([$this->memberSiteAnnecy]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellAnnecy));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cellAnnecy));
        $cellChambery = $this->granularitySite->getCellByMembers([$this->memberSiteChambery]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cellChambery));
        ...
        // Cellules de la granularité année zonne marque.
        $cell2012EuropeA = $this->granularityAnneeZoneMarque->getCellByMembers([$this->memberAnnee2012, $this->memberZoneEurope, $this->memberMarqueA]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012EuropeA));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012SudameriqueB));
        $cell2013EuropeA = $this->granularityAnneeZoneMarque->getCellByMembers([$this->memberAnnee2013, $this->memberZoneEurope, $this->memberMarqueA]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013EuropeA));
        ...
        // Cellules de la granularité année site.
        $cell2012Annecy = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2012, $this->memberSiteAnnecy]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Annecy));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Annecy));
        $cell2012Chambery = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2012, $this->memberSiteChambery]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012Chambery));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012Lima));
        $cell2013Annecy = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2013, $this->memberSiteAnnecy]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Annecy));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013Annecy));
        $cell2013Chambery = $this->granularityAnneeSite->getCellByMembers([$this->memberAnnee2013, $this->memberSiteChambery]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013Chambery));
        ...
        // Cellules de la granularité année site categorie.
        $cell2012AnnecyEnergie = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberSiteAnnecy, $this->memberCategorieEnergie]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012AnnecyEnergie));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012AnnecyEnergie));
        $cell2012ChamberyEnergie = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberSiteChambery, $this->memberCategorieEnergie]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012ChamberyEnergie));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012LimaEnergie));
        $cell2013AnnecyEnergie = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteAnnecy, $this->memberCategorieEnergie]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013AnnecyEnergie));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013AnnecyEnergie));
        $cell2013ChamberyEnergie = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteChambery, $this->memberCategorieEnergie]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013ChamberyEnergie));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013LimaEnergie));
        $cell2012AnnecyTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberSiteAnnecy, $this->memberCategorieTransport]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012AnnecyTransport));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012AnnecyTransport));
        $cell2012ChamberyTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2012, $this->memberSiteChambery, $this->memberCategorieTransport]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2012ChamberyTransport));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2012LimaTransport));
        $cell2013AnnecyTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteAnnecy, $this->memberCategorieTransport]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013AnnecyTransport));
        ...
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::ALLOW(), $cell2013AnnecyTransport));
        $cell2013ChamberyTransport = $this->granularityAnneeSiteCategorie->getCellByMembers([$this->memberAnnee2013, $this->memberSiteChambery, $this->memberCategorieTransport]);
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $cell2013ChamberyTransport));
        ...
        $reportEuropeA = $cellEuropeA->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportEuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportEuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportEuropeA));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportEuropeA));
        $reportEuropeB = $cellEuropeB->getDWCube()->getReports()[0];
        ...
        $reportAnnecy = $cellAnnecy->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportAnnecy));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportAnnecy));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportAnnecy));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportAnnecy));
        $reportChambery = $cellChambery->getDWCube()->getReports()[0];
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::VIEW(), $reportChambery));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::EDIT(), $reportChambery));
        $this->assertFalse($this->aclService->isAllowed($user, Orga_Action_Report::EDIT(), $reportChambery));
        $this->assertFalse($this->aclService->isAllowed($user, User_Model_Action_Default::DELETE(), $reportChambery));
        $reportBerlin = $cellBerlin->getDWCube()->getReports()[0];
    ...
    public function tACLFilterOrganizationAdministrator()
    {
        ...
        $queryAllow->aclFilter->action = User_Model_Action_Default::ALLOW();
