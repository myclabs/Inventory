...
class DWFormConfiguration extends GenericTag
{
     ...
     */
    public function __construct(Report $report, $hash, Translator $translator)
    {
        $this->translator = $translator;

        $reportNumeratorIndicator = $report->getNumeratorIndicator();
        $reportDenominatorIndicator = $report->getDenominatorIndicator();
        ...
        $displayTypePieOption->setAttribute('value', Report::CHART_PIE);
        ...
        $displayTypeVerticalOption->setAttribute('value', Report::CHART_VERTICAL);
        ...
        $displayTypeHorizontalOption->setAttribute('value', Report::CHART_HORIZONTAL);
        ...
        $displayTypeVerticalStackedOption->setAttribute('value', Report::CHART_VERTICAL_STACKED);
        ...
        $displayTypeVerticalGroupedOption->setAttribute('value', Report::CHART_VERTICAL_GROUPED);
        ...
        $displayTypeHorizontalStackedOption->setAttribute('value', Report::CHART_HORIZONTAL_STACKED);
        ...
        $displayTypeHorizontalGroupedOption->setAttribute('value', Report::CHART_HORIZONTAL_GROUPED);
