...
class AF extends Core_Model_Entity
{
     ...
     * @var \AF\Domain\Algorithm\AlgoSet
     */
    protected $algoSet;
    ...
    public function generateForm(
        ...
        $generationHelper = new GenerationHelper($inputSet, $mode);
    ...
    {
        $generationHelper = new GenerationHelper($inputSet, $generationHelper->getMode());
    ...
    public function execute(InputSet $inputSet)
    {
        ...
        foreach ($inputSet->getInputs() as $input) {
            ...
            if ($input instanceof NotRepeatedSubAFInput) {
                ...
                /** @var $subAf \AF\Domain\AF\Component\SubAF\NotRepeatedSubAF */
            ...
            if ($input instanceof RepeatedSubAFInput) {
                ...
                /** @var $subAf \AF\Domain\AF\Component\SubAF\RepeatedSubAF */
                $subAf = $input->getComponent();
