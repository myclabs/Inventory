...
class EntityManagerListener
{
    ...
    public function __construct(ACLFilterService $aclFilterService)
    {
    ...
    public function onFlush(OnFlushEventArgs $eventArgs)
    {
        ...
        foreach ($uow->getScheduledCollectionDeletions() as $col) {
            ...
            $owner = $col->getOwner();
            if ($owner instanceof User && $col->getTypeClass()->getName() === 'User\Domain\ACL\Role') {
