...
class Techno_Datagrid_Translate_Elements_DocumentationController extends UI_Controller_Datagrid
{
    ...
    public function getelementsAction()
    {
        ...
        $this->totalElements = Element::countTotal($this->request);
    ...
    {
        $element = Element::load($this->update['index']);
        $element->reloadWithLocale(Core_Locale::load($this->update['column']));
    ...
    public function viewAction()
    {
        ...
        $element = Element::load($this->getParam('id'));
