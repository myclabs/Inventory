 ...
 * @package Social
 */
class Inventory_Datagrid_Cell_Actions_ContextController extends UI_Controller_Datagrid
{
    ...
    public function getelementsAction()
    {
        ...
        foreach ($cellDataProvider->getSocialContextActions() as $contextAction) {
            $data = [];
            ...
            $data['details'] = $this->cellLink(
                'inventory/cell/contextactiondetails/id/'.$contextAction->getId().'/idCell/'.$idCell,
                __('UI', 'name', 'details'),
                'share-alt'
            );
    ...
    public function addelementAction()
    {
        ...
        if (count($this->_addErrorMessages) === 0) {
            ...
            $contextAction->save();
            $cellDataProvider->addSocialContextAction($contextAction);
    ...
    function deleteelementAction()
    {
        ...
        $cellDataProvider->removeSocialContextAction($contextAction);
