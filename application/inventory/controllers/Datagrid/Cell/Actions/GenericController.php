 ...
 * @package Social
 */
class Inventory_Datagrid_Cell_Actions_GenericController extends UI_Controller_Datagrid
{
    ...
    public function getelementsAction()
    {
        ...
        foreach ($cellDataProvider->getSocialGenericActions() as $genericAction) {
            ...
            $data['details'] = $this->cellLink(
                'inventory/cell/genericactiondetails/id/'.$genericAction->getId().'/idCell/'.$idCell,
                __('UI', 'name', 'details'),
                'share-alt'
            );
            $this->addLine($data);
    ...
    public function addelementAction()
    {
        ...
        if (count($this->_addErrorMessages) === 0) {
            ...
            $genericAction->save();
            $cellDataProvider->addSocialGenericAction($genericAction);
    ...
    function deleteelementAction()
    {
        ...
        if (count($genericAction->getContextActions()) > 0) {
            ...
            $cellDataProvider->removeSocialGenericAction($genericAction);
