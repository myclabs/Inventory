...
class AF_Populate extends Core_Script_Action
{
    ...
    /**
     * @param string $label
     * @param \AF\Domain\Category $parent
     * @return Category
     */
    ...
    /**
     * @param AF $aF
     * @param \AF\Domain\Component\Group $parentGroup
     * @param $ref
     * @param $label
     * @param bool $foldaway
     * @param null $help
     ...
     * @param null $help
     * @param bool $visible
     * @return \AF\Domain\AF\Component\\AF\Domain\Component\Component
     */
     ...
     * @param AF $aF
     * @param $ref
     * @return \AF\Domain\Condition\ExpressionCondition
     */
